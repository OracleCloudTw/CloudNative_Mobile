...
2. In line 12, change the URL to your identity domain, i.e. in the format of **`http://<IP Address used in #1 JavaApp Lab>/ptmgt/v1/offers/`**. As you can see, this is the URL of the **Offer REST API Microservice**
